...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl md:text-5xl font-bold text-slate-800 mb-6">📍 Add New Address</h1>
            <p class="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Add your home or office address for easy checkout
            </p>
        </div>
            ...
            <form action="{{ route('addresses.store') }}" method="POST" class="space-y-8">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <label class="relative cursor-pointer">
                            ...
                            <div class="address-type-card bg-gradient-to-br from-green-50 to-blue-50 border-2 border-green-200 rounded-2xl p-6 text-center transition-all duration-300 hover:shadow-lg">
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="type" value="office" class="sr-only">
                            <div class="address-type-card bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-2xl p-6 text-center transition-all duration-300 hover:shadow-lg">
                                <div class="text-4xl mb-3">🏢</div>
                ...
                <div class="flex items-center">
                    ...
                    <label for="is_default" class="ml-3 text-lg font-semibold text-slate-700">
                        Set as default {{ old('type', 'home') }} address
                    </label>
                </div>
